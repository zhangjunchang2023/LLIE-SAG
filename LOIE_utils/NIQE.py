...
from LOIE_utils.Utils_niqe import reorder_image, to_y_channel,imresize
...
if __name__ =='__main__':
    ...
    clean = io.imread('test_inside/1.jpg')
    noisy = io.imread('test_inside/1.jpg')
    params_path = '../niqemodels/'
    '''
    NIQE值越小,图像质量越好。
    '''
